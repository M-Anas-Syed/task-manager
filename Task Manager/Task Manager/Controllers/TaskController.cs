...
namespace Task_Manager.Controllers
{
    public class TaskController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TaskTitle,TaskDescription")] Task task)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TaskTitle,TaskDescription")] Task task)
        {
            if (id != task.Id)
            {
                return NotFound();
